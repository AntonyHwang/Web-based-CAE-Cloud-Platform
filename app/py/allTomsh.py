...
def mshTox3d(filename, job_id):
    ...
    f = open('C:\\Users\\MD580\\Desktop\\Web-based-CAE-Cloud-Platform\\app\\gmsh_output\\{}\\mesh.x3d'.format(job_id), 'w')
...
def checkFile(job_id):
    file = "C:\\Users\\MD580\\Desktop\\Web-based-CAE-Cloud-Platform\\app\\gmsh_output\\{}\\all.msh".format(job_id)
    counter = 0
    with open(file) as f:
...
if __name__ == "__main__":
    job_id = sys.argv[1]
    if (checkFile(job_id)):
        read_all_msh("C:\\Users\\MD580\\Desktop\\Web-based-CAE-Cloud-Platform\\app\\gmsh_output\\{}\\all.msh".format(job_id), "C:\\Users\\MD580\\Desktop\\Web-based-CAE-Cloud-Platform\\app\\gmsh_output\\{}\\temp.msh".format(job_id))
        mshTox3d("C:\\Users\\MD580\\Desktop\\Web-based-CAE-Cloud-Platform\\app\\gmsh_output\\{}\\temp.msh".format(job_id), job_id)
        print("success")
    else:
        print("fail")