...
def vtk_stress(job_id):
    vtk = open('C:/Users/MD580/Desktop/Web-based-CAE-Cloud-Platform/app/jobs/' + str(job_id) + '/solve_mmh.vtk', 'rU')
    ...
    for j in range(len(current_list)):
        ...
        vtk_lines.append(str(val) + '\n')
        j += 1

    vtk = open('C:/Users/MD580/Desktop/Web-based-CAE-Cloud-Platform/app/jobs/' + str(job_id) + '/solve_mmh.vtk', 'w+')
