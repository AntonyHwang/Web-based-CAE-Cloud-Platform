        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="picture_display" style="background-image: url(&quot;jobs/<?php echo $_GET['job_id'];?>/disp.png&quot;)"></div>
                </div>
                <div class="col-md-4">
                    <div class="picture_display" style="background-image: url(&quot;jobs/<?php echo $_GET['job_id'];?>/se.png&quot;)"></div>
